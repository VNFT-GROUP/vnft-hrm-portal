    ...
    const fetchProfile = async () => {
      try {
        ...
        if (res.data) {
           ...
           if (d.cvUrl) setCvOriginalUrl(d.cvUrl);
        }
        setIsFetching(false);
      } catch (err) {
                  ...
                  <div className="space-y-1.5 text-center sm:text-left">
                     ...
                     <div className="flex items-center justify-center sm:justify-start gap-2 mt-3">
                         ...
                         {(avatarPreview || session?.avatarUrl || session?.username) && (
                           <Button type="button" onClick={(e: React.MouseEvent) => handleRotateImage(e, 'avatar')} variant="outline" size="sm" className="rounded-xl text-xs font-medium bg-card hover:bg-blue-50 hover:text-blue-600 border-border hover:border-blue-200 transition-colors gap-1.5 px-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                      ...
                      <div className="flex flex-col gap-2">
                          ...
                          {citizenIdFrontPreview && (
                              <div className="flex justify-end">
                                 <Button type="button" onClick={(e: React.MouseEvent) => handleRotateImage(e, 'front')} variant="outline" size="sm" className="h-8 text-xs rounded-lg gap-1.5 font-medium bg-card hover:bg-blue-50 hover:text-blue-600 border-border hover:border-blue-200 transition-colors">
                                    <RotateCw size={14} /> Xoay ảnh
                                 </Button>
                              </div>
                          )}
                   ...
                   <div className="space-y-3 relative group">
                      ...
                      <div className="flex flex-col gap-2">
                          ...
                          {citizenIdBackPreview && (
                              <div className="flex justify-end">
                                 <Button type="button" onClick={(e: React.MouseEvent) => handleRotateImage(e, 'back')} variant="outline" size="sm" className="h-8 text-xs rounded-lg gap-1.5 font-medium bg-card hover:bg-blue-50 hover:text-blue-600 border-border hover:border-blue-200 transition-colors">
                                    <RotateCw size={14} /> Xoay ảnh
                                 </Button>
                              </div>
                          )}
