...
export default function EmployeeCodeTable({ data, onToggleActive }: { data: EmployeeCodeResponse[], onToggleActive: (id: string) => void }) {
  return (
      ...
      <Table className="border-collapse">
            <TableHeader className="bg-muted/80">
              <TableRow className="border-b border-border hover:bg-transparent">
                ...
                <TableHead className="font-semibold text-foreground w-[150px] text-center align-middle px-4">Trạng thái</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              <AnimatePresence>
