...
import AttendanceTable, { AttendanceJsonDialog } from "./components/AttendanceTable";
...
export default function AttendancePage() {
  ...
  const { data: attendanceData, isLoading } = useQuery({
    ...
    queryFn: () => attendanceService.getAttendanceRecords(startDate || undefined, endDate || undefined, debouncedSearch || undefined, page, size),
  });
