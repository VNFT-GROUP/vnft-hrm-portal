...
/**
 * Public Verify Page — entry point for CRM.
 *
 * Flow:
 *  1. User arrives at crm.dev.local:3002 (any non-/app route falls here)
      ...
      <div className="flex flex-col items-center gap-6 max-w-md text-center px-6">
        ...
        <div className="relative flex items-center justify-center">
          <div
            ...
            style={{ backgroundColor: 'rgba(14, 165, 233, 0.1)', animationDuration: '3s' }}
          />
          <div className="relative z-10 w-20 h-20 bg-white rounded-2xl shadow-xl border border-slate-100 flex items-center justify-center p-3"
               style={{ boxShadow: '0 10px 30px rgba(14, 165, 233, 0.08)' }}>
            <img
        ...
        <div className="flex flex-col items-center gap-1.5 mt-2">
          <span className="text-base font-bold tracking-widest uppercase" style={{ color: '#0c4a6e' }}>
            VNFT Group — CRM
          </span>
          {error ? (
