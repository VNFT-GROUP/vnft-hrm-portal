...
export default function LoadingPage({
  ...
  // Use ref-based callback to avoid re-creating the interval when onComplete changes
  const stableOnComplete = useCallback(() => {
    onCompleteRef.current?.();
  }, []);

  useEffect(() => {
    const interval = 50; // slower tick = fewer re-renders (was 30ms)
  ...
  // Memoize the clamped progress to avoid inline recalculation
  ...
  return (
    <div className="loading-page">
      {/* Background decorations — pure CSS, no JS cost */}
