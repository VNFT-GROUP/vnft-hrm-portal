      ...
      <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 hover:border-slate-200 hover:shadow-md transition-all duration-300 group hover:-translate-y-1">
        ...
        <div className="flex flex-col gap-6">
          <div className="p-4 bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl text-white shadow-md relative overflow-hidden group/card hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300 cursor-pointer">
            ...
            <div className="mb-6">
              <div className="text-slate-400 text-xs font-semibold uppercase tracking-wider mb-1">Số Tài Khoản</div>
              <div className="text-2xl font-mono tracking-widest">1380 306 330</div>
            </div>
            <div>
              <div className="text-slate-400 text-xs font-semibold uppercase tracking-wider mb-1">Tên Tài Khoản</div>
        ...
        <div className="space-y-6">
          ...
          <div>
            <div className="flex justify-between items-center mb-2">
              <span className="text-sm font-semibold text-slate-700">CCCD mặt trước</span>
            ...
            <div className="flex flex-col items-center justify-center p-6 text-center bg-slate-50/50 rounded-xl border border-dashed border-slate-300 h-[140px] hover:bg-slate-50 hover:border-[#2E3192]/50 hover:shadow-inner transition-all duration-300 group/upload cursor-pointer">
              <FileImage size={24} className="text-slate-300 mb-2 group-hover/upload:scale-110 group-hover/upload:text-slate-400 transition-transform duration-300" />
              <p className="text-slate-500 font-medium text-sm group-hover/upload:text-[#2E3192] transition-colors duration-300">Chưa có ảnh</p>
            </div>
          </div>
          ...
          <div>
            <div className="flex justify-between items-center mb-2">
              <span className="text-sm font-semibold text-slate-700">CCCD mặt sau</span>
              <button className="flex items-center gap-1.5 text-xs text-[#2E3192] font-semibold hover:bg-[#2E3192]/10 px-2 py-1 rounded transition-colors">
                <UploadCloud size={14} /> Upload
              </button>
            </div>
